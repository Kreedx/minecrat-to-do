        ...
        <div className="flex items-center space-x-4">
          <div className="relative" ref={menuRef}>
            ...
            >
              ...
              <svg
                className={`ml-1 w-4 h-4 text-indigo-400 transition-transform duration-200 ${showProfileMenu ? "rotate-180" : "rotate-0"}`}
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
                viewBox="0 0 24 24"
                  ...
                  {showProfileMenu && (
                    ...
                    <div className="px-5 py-4 border-b border-gray-100 text-sm space-y-2">
                      ...
                      <span className="text-gray-500">Member Since: </span>
                        <span className="font-gray-900 font-medium"> 
                    ...
                    <button
                      ...
                      className="w-full px-4 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg transition-colors flex items-center gap-2"
                    >
